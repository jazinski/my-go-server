...
func loadResource(srv *server.MCPServer, filePath string) {
	...
	srv.AddResource(resource, func(ctx context.Context, request mcp.ReadResourceRequest) (*mcp.ReadResourceResult, error) {
		return mcp.NewReadResourceResult(string(content)), nil
	})
}
