...
func loadResourcesAndPrompts(srv *server.MCPServer) {
	// For now, let's focus on prompts since they're simpler to implement
	...
	// TODO: Implement resource loading once we understand the correct API
	fmt.Fprintf(os.Stderr, "Info: Resource loading temporarily disabled - will implement once API is clarified\n")
}

// loadResource loads a resource from a markdown file (temporarily commented out)
/*
func loadResource(srv *server.MCPServer, filePath string) {
	// Will implement once we understand the correct resource API
}
*/
