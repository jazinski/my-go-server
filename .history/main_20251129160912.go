...
func main() {
	...
	// Python executor
	pyTool := mcp.NewTool("execute_python",
		mcp.WithDescription("Execute Python code in an isolated enviornment. Playwright and headless browser are available for web scraping"),
		mcp.WithString("code", mcp.Required(), mcp.Description("Python code to execute")),
		mcp.WithString("modules", mcp.Description("Comma-separated list of Python modules your code requires. If your code required external modules you"))
	)
